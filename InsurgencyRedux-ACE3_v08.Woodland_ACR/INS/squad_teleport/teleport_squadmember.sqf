...
switch (side _unit) do {
	case WEST : { enemyunits = {side _x == east} count ((position _playerUnit) nearEntities [["Man"],__NMEDISTANCE]); };
	case EAST : { enemyunits = {side _x == west} count ((position _playerUnit) nearEntities [["Man"],__NMEDISTANCE]); };
	case RESISTANCE : { enemyunits = {side _x == west} count ((position _playerUnit) nearEntities [["Man"],__NMEDISTANCE]); };
};
